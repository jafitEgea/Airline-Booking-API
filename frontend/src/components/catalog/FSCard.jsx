...
const FSCard = () => {
    const sxcard = {
        'my':2, 'mx':6, 'height':180,
        'bgcolor':'#c19ee0', 'boxShadow':3,
        'borderBottom':4, 'borderBottomColor':'#240046',
        'backgroundImage':'linear-gradient(40deg, #a06cd5, #c19ee0, #d2b7e5, #a06cd5)',
            ...
            <CardContent>
                    <Grid container rowSpacing={1}>
                      ...
                      <Grid item flexGrow={1} sx={{display:'flex', justifyContent:'center'}}>
                        <Stack direction="row" maxWidth={100} border={1} sx={{bgcolor: '#240046', boxShadow:1, borderRadius:1, px:0.5, alignItems:'center'}}>
